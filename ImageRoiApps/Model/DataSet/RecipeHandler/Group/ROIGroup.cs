...
using System.Xml;
using ClipXmlReader.Model.DataSet.RecipeHandler.Coordinate;
        ...
        public Coordinate.TransformStatus SubOffset
        {
            get
            {
                ...
                else
                {
                    ...
                    var suboffset = new TransformStatus(); //SpecifiedParent.AncestorMeasureObject.SpecifiedParent.UserTransformParameter[coordid];
